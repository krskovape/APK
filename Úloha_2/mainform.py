...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/longest_edge.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icons/weighted_bisector.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
