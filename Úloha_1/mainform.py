...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.buttonRepaint.setStyleSheet("QPushButton {border-image: url(icons/scale.png);}")
        ...
        self.actionFitToDisplay = QtGui.QAction(parent=MainForm)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/scale.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionFitToDisplay.setIcon(icon4)
